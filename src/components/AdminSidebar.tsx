...
export default function AdminSidebar() {
  ...
  const links = [
    ...
    { name: "Manage Patients", path: "/admin/users/patients" },
    { name: "Manage Doctors", path: "/admin/users/doctors" },
    { name: "Manage Radiologists", path: "/admin/users/radiologists" },
    { name: "Appointments", path: "/admin/appointments" },
    { name: "Scan Logs", path: "/admin/scans" },
  ];
    ...
    <>
      ...
      <button
        ...
        className={`
          ...
          shadow-[4px_0_15px_rgba(37,99,235,0.2)] focus:outline-none 
