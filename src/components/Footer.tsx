...
export default function Footer() {
  return (
    <>
      <footer className="mt-12 md:mt-15 bg-[#060b30]/90 foot py-8 px-4 sm:px-6 md:px-12 text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1600px] mx-auto text-center md:text-left">
          ...
          <div className="p-0 flex flex-col gap-3 items-center md:items-start">
          ...
          <div className="p-0 flex flex-col gap-2 md:col-span-2 lg:col-span-1 items-center md:items-start">
        ...
        {/* Lower Row Copyright */}
        <hr className="my-6 border-white/10 max-w-[1600px] mx-auto" />
