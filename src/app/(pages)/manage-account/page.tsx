...
export default function ManageAccountPage() {
  ...
  if (!isAuthenticated) {
    return <div className="min-h-screen flex items-center justify-center text-white px-4 text-center text-sm sm:text-base">Please log in to manage your account.</div>;
  }
    ...
    <div className="min-h-screen bg-transparent text-white pt-20 sm:pt-24 px-4 pb-12">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="text-left">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-100 leading-tight">Account Settings</h1>
          <p className="text-gray-400 text-xs sm:text-sm mt-1">Manage your personal information and security preferences.</p>
        </div>
        ...
        <div className="bg-[#121726] border border-[#2a3655] rounded-2xl p-5 sm:p-8 shadow-xl">
          <h2 className="text-lg sm:text-xl font-bold text-white mb-5 sm:mb-6 flex items-center gap-2">
            <svg className="w-5 h-5 text-blue-500 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-5 sm:space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              {/* Age */}
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-400 mb-1.5 sm:mb-2">Age</label>
                <input 
                  type="number" 
              ...
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-400 mb-1.5 sm:mb-2">Account Type</label>
                <input 
                  type="text" 
                  value={user?.role || ""}
                  disabled
            ...
            <div className="flex justify-end pt-4 border-t border-gray-800">
              <button type="submit" className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-colors w-full sm:w-auto">
                Save Changes
              </button>
            </div>
          </form>
        ...
        <div className="bg-[#121726] border border-[#2a3655] rounded-2xl p-5 sm:p-8 shadow-xl">
          <h2 className="text-lg sm:text-xl font-bold text-white mb-5 sm:mb-6 flex items-center gap-2">
            <svg className="w-5 h-5 text-emerald-500 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
            Security & Password
          </h2>
          
          <form onSubmit={handleUpdatePassword} className="space-y-5 sm:space-y-6 max-w-md w-full">
            <div>
              <label className="block text-xs sm:text-sm font-medium text-gray-400 mb-1.5 sm:mb-2">Current Password</label>
              <input 
                type="password" 
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-gray-400 mb-1.5 sm:mb-2">New Password</label>
              <input 
                type="password" 
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-gray-400 mb-1.5 sm:mb-2">Confirm New Password</label>
              <input 
                type="password" 
            ...
            <div className="pt-4 border-t border-gray-800">
              <button type="submit" className="bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-colors w-full sm:w-auto">
                Update Password
              </button>
            </div>
          </form>
        ...
        <div className="bg-red-950/10 border border-red-900/30 rounded-2xl p-5 sm:p-8 shadow-xl w-full">
          <h2 className="text-lg sm:text-xl font-bold text-red-500 mb-2 flex items-center gap-2">
            <svg className="w-5 h-5 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
            Danger Zone
          </h2>
          <p className="text-gray-400 text-xs sm:text-sm mb-5 sm:mb-6 leading-relaxed">Once you delete your account, there is no going back. All your medical scans, history, and appointments will be permanently erased.</p>
