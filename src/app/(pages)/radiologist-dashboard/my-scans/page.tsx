...
import { Brain, Download, Loader2, ScanLine } from "lucide-react";
    ...
    <ProtectedRoute>
      <div className="p-4 sm:p-6">
        <div className="mb-8 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between animate-fade-in-up">
          ...
          <div className="rounded-xl border border-blue-500/30 bg-blue-600/10 backdrop-blur-sm px-5 py-3 text-sm text-blue-200">
            My Scans:{" "}
        ...
        {scans.length === 0 ? (
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-10 text-center shadow-xl animate-fade-in-up">
            <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 2xl:grid-cols-2 gap-6">
            {scans.map((scan, index) => {
              ...
              return (
                <div
                  key={scan._id}
                  className="rounded-2xl border border-white/10 bg-[#12172a]/80 backdrop-blur-md shadow-xl overflow-hidden hover:border-blue-500/30 transition-all duration-300 animate-fade-in-up"
